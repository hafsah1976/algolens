# AlgoLens Contest Submission

## One-liner

AlgoLens is a calm visual DSA learning platform that helps beginners understand algorithms by stepping through state changes instead of reading walls of text.
...
- Admin panel for topics, lessons, quizzes, and problems
- MongoDB persistence for users, progress, attempts, submissions, and content
...
8. Take a quiz or show quiz result explanations.
9. Open a coding problem and submit code.
10. Show the admin panel as the content workflow.
