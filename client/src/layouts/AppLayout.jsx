    ...
    <div className="relative isolate min-h-screen overflow-hidden">
      ...
      {menuOpen ? (
        <div className="fixed inset-0 z-50 bg-ink/20 backdrop-blur-sm lg:hidden">
          <div className="h-full max-w-[320px] border-r border-line/70 bg-surface-strong px-5 py-5 shadow-[0_30px_80px_rgba(21,32,25,0.18)]">
            ...
            <AppSidebar focusMode={focusMode} onNavigate={() => setMenuOpen(false)} />
          </div>
        </div>
      ) : null}
    </div>
